...
def variant_run(bed_file,ref,draft,bed_out_name='map',variant_out_name='calling_variant',output_path=os.getcwd(),software=os.path.dirname(os.path.realpath(__file__))+'/scr/variant_caller_29_4.py',filterate=os.path.dirname(os.path.realpath(__file__))+'/scr/filter.py',chr_spliter="' '",contig_spliter="' '",bse=1,qual=30,q='multicore20',core=4,job_name='Awad_v_c',submit=False):
