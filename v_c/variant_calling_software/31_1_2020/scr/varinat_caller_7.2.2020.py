...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb  7 17:09:27 2020
...
def variant_caller(bed_file,ref_genome,draft,output_path=os.getcwd(),output_name='var_call_awad',chr_spliter=' ',contig_spliter=' ',bse=1,qty=30):
    ...
    for key in z.keys():
        ...
        for base in q:
            h.writelines(base)
    h.close()
    h=open(h=open(output_path+'/'+output_name+'_runtime_new','w'))
